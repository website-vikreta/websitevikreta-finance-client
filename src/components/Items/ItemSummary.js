...
const ItemsTable = ({ items }) => {
   ...
   const currentQuarterProfit = (currQaurtrTotalProfit === lastQaurtrTotalProfit) ? 0:(lastQaurtrTotalProfit === 0 || ((currQaurtrTotalProfit < lastQaurtrTotalProfit) && currQaurtrTotalProfit < 0)) ? 100: (currQaurtrTotalProfit > lastQaurtrTotalProfit && lastQaurtrTotalProfit < 0) ? (((currQaurtrTotalProfit-lastQaurtrTotalProfit)/lastQaurtrTotalProfit)*100).toFixed(2) : (((currQaurtrTotalProfit-lastQaurtrTotalProfit)/lastQaurtrTotalProfit)*100).toFixed(2);
